...
config. CloseBtnColors	= ['#C18EDB', '#FFFFFF', '#DD3333', '#FFFFFF']	// [Background, text, hovered background, hovered text] - use empty strings '' to inherit title colours
config. CloseBtnText	= 'i '	// Close button text (may also be an image tag)
...
config. FadeOut			= 100
config. FadeInterval	= 25		// Duration of each fade step in ms (recommended: 30) - shorter is smoother but causes more CPU-load
...
config. Title			= 'Information'		// Default title text applied to all tips (no default title: empty string '')
config. TitleAlign		= 'left'	// 'left' or 'right' - text alignment inside the title bar
config. TitleBgColor	= '#C18EDB'		// If empty string '', BorderColor will be used
