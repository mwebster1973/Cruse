...
var MENU_ITEMS = [
	['Home page', 'http://www.softcomplex.com/support.html'],
	['Search TRs <img style="margin-bottom:0px;" border="0"	src="./images/YellowArrow.gif">', null, null,
	...
	['Define Tests <img style="margin-bottom:0px;" border="0"	src="./images/YellowArrow.gif">', null, null,
	...
	['Reporting <img style="margin-bottom:0px;" border="0"	src="./images/YellowArrow.gif">', null, null,
	...
	['Maintenance <img style="margin-bottom:0px;" border="0"	src="./images/YellowArrow.gif">', 'http://www.softcomplex.com/support.html']
