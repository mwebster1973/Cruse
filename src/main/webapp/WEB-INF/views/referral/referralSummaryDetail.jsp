...
<butter:pageContainer pageTitle="${title}">
	...
	<butter:tab title="Summary details">
		...
		<butter:tabLink type="export" link="referralSummaryDetail.htm?id=${param.id}&referralSummaryDetail.export=Y" />
		<butter:tabBody type="results">
			<butter:table id="referralSummaryDetail" pageSize="18" name="detail"
				refreshAction="referralSummaryDetail.htm?id=${param.id}"
				exportTitle="${title}"
