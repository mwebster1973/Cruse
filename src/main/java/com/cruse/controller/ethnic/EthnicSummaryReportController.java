...
@Controller
@RequestMapping("/ethnicSummaryReport.htm")
public class EthnicSummaryReportController extends CruseSearchController {
	...
	protected ModelAndView handleRequestInternal(HttpServletRequest request,
		...
		mv.addObject("pageTitle", "Cultural Background Summary");
